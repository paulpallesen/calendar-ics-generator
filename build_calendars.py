...
from ics.parse import ContentLine  # Correct import for ics==0.8.0.dev0
...
for name, group in grouped:
    ...
    cal = Calendar()
    cal.extra.append(ContentLine(name='X-WR-CALNAME', value=str(name)))  # Use ContentLine for ics==0.8.0.dev0
    cal.extra.append(ContentLine(name='X-WR-TIMEZONE', value='Australia/Sydney'))  # Use ContentLine for ics==0.8.0.dev0
