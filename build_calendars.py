...
# --text        (#dde7f6)  : Primary text
# --muted       (#a4b5c9)  : Muted/subtext
#
...
# --outlook-bg  (#0A74DA)  : Outlook button background
...
.badge{display:inline-block;background:var(--badge-bg);color:var(--badge-text);padding:6px 10px;border-radius:999px;font-size:12px;margin-left:8px}

.row{display:flex;gap:12px;flex-wrap:wrap;margin:16px 0}
button,select{font-size:16px;border-radius:12px;border:1px solid var(--border);padding:10px 14px}
